...
const transformFormToInsert = (
  ...
  quality_status: (form.quality_status || 'pending') as QualityTestInsert['quality_status'],
  ...
  const updateTest = useMutation({
    mutationFn: async ({ id, ...updates }: { id: string } & Partial<QualityTestFormData>): Promise<QualityTestRow> => {
      const updateData: QualityTestUpdate = {
        ...
        quality_status: updates.quality_status as QualityTestUpdate['quality_status'],
